const translations = {
  ...
  zh: {
    ...
    focusTitle: "研究议程",
    focusOneTitle: "协同治理",
    focusOneText: "协作中的沟通机制与冲突调解。",
    focusTwoTitle: "行为公共管理",
    focusTwoText: "行为假设、政策反馈与实验方法。",
    focusThreeTitle: "政府沟通",
    focusThreeText: "公众态度、地方文化与政策议题沟通。",
    researchKicker: "研究",
